...
namespace NSmartProxy.Shared
{
    ...
    public sealed class Global
    {
        ...
        public const int HeartbeatInterval = 10000;  //心跳间隔（毫秒），保持低于常见链路/NAT的30秒空闲回收阈值
        ...
        public const int ClientTunnelBufferSize = 64 * 1024; //客户端数据包大小
        ...
        public const int ServerTunnelBufferSize = 64 * 1024;//服务端数据包大小
